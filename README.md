...
This is a curated list of awesome development resources.
I find them very useful and worth looking at.
...
- [fish](https://github.com/fish-shell/fish-shell) - a user-friendly command line shell.

## Hardware

- [LACT](https://github.com/ilya-zlobintsev/LACT) - a Linux GPU configuration and monitoring tool.
...
- [D3.js](https://d3js.org/) - a JavaScript library for producing dynamic, interactive data visualizations in the browser.

## Node.js

- [fnm](https://github.com/Schniz/fnm) - a fast and simple Node.js version manager, built in Rust.
